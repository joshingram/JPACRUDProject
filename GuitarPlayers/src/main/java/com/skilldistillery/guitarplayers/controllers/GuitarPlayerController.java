...
public class GuitarPlayerController {
	...
	public ModelAndView addPlayer(String firstName, String lastName, String guitarBrand, 
								String birthPlace, String birthCountry, String remarks, LocalDate birthDay, LocalDate deceasedDay, RedirectAttributes redir){  //
		ModelAndView mv = new ModelAndView();
		Player player = new Player(firstName, lastName, guitarBrand, birthPlace, birthCountry, birthDay, deceasedDay, remarks);

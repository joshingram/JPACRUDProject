...
START TRANSACTION;
USE `guitarplayersdb`;
INSERT INTO `player` (`id`, `first_name`, `last_name`, `guitar_brand`, `birth_place`, `birth_country`, `birth_day`, `deceased_day`, `image_url`, `remarks`) VALUES (1, 'Eddie', DEFAULT, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
